<template>
  <div class="detail-view">
    ...
    <div v-else>
      ...
      <button v-if="isLaterVideo" type="button" class="btn btn-danger" v-on:click="unregisterLaterVideo">
        저장 취소
      </button>
      <button v-else type="button" class="btn btn-primary" v-on:click="registerLaterVideo">
        동영상 저장
      </button>
    </div>
  </div>
